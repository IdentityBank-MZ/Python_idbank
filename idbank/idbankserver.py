...
versionString = "0.0.2"
applicationNameString = "idbankserver"
applicationDescriptionString = "ID Bank Server"
...
def main(argv=sys.argv):
    ...
    for key, value in args.items():
        logging.info('** [{}]: [{}]'.format(' '.join(''.join([w[0].upper(), w[1:].lower()]) for w in (re.sub("([a-z])([A-Z])", "\g<1> \g<2>", key)).split()), value))
